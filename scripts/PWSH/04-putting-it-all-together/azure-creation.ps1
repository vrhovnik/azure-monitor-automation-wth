...
# Version 0.4.6
# SHORT CHANGE DESCRIPTION: preparing parameters to be used by system
#>

$rgName=$env:RGNAME
$location=$env:AZURELOCATION
$containerappenv=$env:CONTAINERAPPENVNAME
$containerAppName = $env:CONTAINERAPPNAME

Write-Host "Starting registry deploy in $rgName"
Set-Location ".\scripts\PWSH\04-putting-it-all-together\"
